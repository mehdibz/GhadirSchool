...
<!-- <script type="text/javascript"  src="Script/angular.min.js"></script>  -->
    ...
    <script type="text/javascript"  src="Script/Student_Angular.js"></script>
	...
	<form name="registrationForm" method="post"  ng-controller="ReportController" ng-submit="createUser(registrationForm.$valid)">
		...
		<table class="curve tbl_reg">
			...
			<tr>
				...
				<td colspan="3"><input class="fix" type="text" id="Name" name="Name" ng-model="user.Name" ng-change="NameCheck()" value="" required="required" placeholder=" *" ng-disabled="isDisabled"/></td>
			</tr>
			<tr>
				<td colspan="1">Last Name</td>
				<td colspan="3"><input class="fix" type="text" name="Family" ng-model="user.Family" ng-change="FamilyCheck()" value="" required="required" placeholder=" *" ng-disabled="isDisabled"/></td>
			</tr>
			<tr>
				<td colspan="1">
					Date of Birth
			...
			<tr>
				...
				<td colspan="3"><textarea id="text_area" name="Details" ng-disabled="isDisabled" ng-model="user.Details"></textarea></td>
			</tr>
			<tr>
