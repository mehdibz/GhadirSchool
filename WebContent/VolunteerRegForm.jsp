...
<!-- <script type="text/javascript"  src="Script/angular.min.js"></script>  -->
    ...
    <script type="text/javascript"  src="Script/Volunteer_Angular.js"></script>
...
<body>
	<form name="registrationForm" method="post"  ng-controller="ReportController" ng-submit="createUser(registrationForm.$valid)">
		...
		<input type=hidden id="isvalid" name="AppSubmit" value="">
		<%
		...
		<table class="curve tbl_reg">
			<tr>
				<th class="curve-top" colspan="4">Volunteer Information</th>
		...
		<table class="curve tbl_reg">
			...
			<tr>
				<td colspan="1">Refrence Name</td>
				<td colspan="3"><input class="fix" type="text" name="RefName" ng-model="user.RefName" value="" required="required" placeholder=" *" ng-disabled="isDisabled"/></td>
			</tr>
			<tr>
				<td colspan="1">Refrence Phone</td>
				<td colspan="3"><input class="fix" type="text" name="RefPhone" maxlength="10" ng-model="user.RefPhone" ng-change="RefPhoneCheck()" valid-number required="required" ng-disabled="isDisabled" placeholder=" *" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="3"><textarea id="text_area" type="text" name="Details" ng-disabled="isDisabled" ng-model="user.Details" required="required" placeholder=" *"></textarea></td>
			</tr>
			<tr>
			...
			<tr>
				<td class="curve-bottom" colspan="4">
					...
					<button type="button" class="button" ng-click="SubmitEnable()">New</button>
