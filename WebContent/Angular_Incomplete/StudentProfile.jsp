	...
	<form name="registrationForm" method="post"  ng-controller="ReportController" ng-submit="createUser(registrationForm.$valid)">
		...
		<table class="curve tbl_reg">
			<tr>
				...
				<td colspan="3"><input class="fix" type="text" id="Name" name="Name1" ng-model="user.Name1" value="" required="required" placeholder=" *" ng-disabled="isDisabled"/></td>
		<!-- 	<td colspan="3"><input class="fix" type="text" id="Name" name="Name" ng-model="user.Name" value= //session.getAttribute("username").toString() required="required" placeholder=" *" ng-disabled="isDisabled"/></td> -->
			...
			<tr>
				...
				<td colspan="3"><input class="fix" type="text" name="Family1" ng-model="user.Family1" value="" required="required" placeholder=" *" ng-disabled="isDisabled"/></td>
			</tr>
			<tr>
				<td colspan="1">
					Date of Birth
				...
				<td colspan="3" >
					<select class="fixMonths" style="background: white" name="MonthSelected1" ng-change="birthDateCheck()" ng-init="user.MonthSelected = 'Month'" ng-model="user.MonthSelected1" ng-style="BirthdateStyle" ng-disabled="isDisabled"> <%
					...
					<select class="fixDays" style="background: white" name="DaysSelected1" ng-change="birthDateCheck()" ng-init="user.DaysSelected = 'Day'" ng-model="user.DaysSelected1" ng-style="BirthdateStyle" ng-disabled="isDisabled"> <%
					...
					<select class="fixYears" style="background: white" name="YearSelected1" ng-change="birthDateCheck()" ng-init="user.YearSelected = 'Year'" ng-model="user.YearSelected1" ng-style="BirthdateStyle" ng-disabled="isDisabled"> <%
			...
			<tr>
				...
				<td colspan="3"><input class="fix" type="text" name="CareCardNo1"  maxlength="10" ng-model="user.CareCardNo1" ng-change="carecardCheck()" valid-number required="required" ng-disabled="isDisabled"  placeholder=" *" /></td>
			</tr>
			<tr>
				<td colspan="1">Primary Phone</td>
				<td colspan="3"><input class="fix" type="text" name="Primary_Phone1" maxlength="10" ng-model="user.Primary_Phone1" ng-change="phoneCheck()" valid-number required="required" ng-disabled="isDisabled" placeholder=" *" /></td>
			</tr>
			<tr>
				<td colspan="1">Emergency Phone</td>
				<td colspan="3"><input class="fix" type="text" name="Emergency_Phone1" maxlength="10" ng-model="user.Emergency_Phone1" ng-change="emergencyCheck()" valid-number required="required" ng-disabled="isDisabled" placeholder=" *" /></td>
			</tr>
			<tr>
				<td colspan="1">Email</td>
				<td colspan="3"><input class="fix" type="email" name="Primary_Email1" required="required" ng-model="user.Primary_Email1" ng-change="EmailCheck()"  ng-disabled="isDisabled" placeholder=" *" /></td>
			</tr>
			<tr>
				<td colspan="1">
					Farsi Grade
				...
				<td colspan="1">
					<select class="fix" style="background: white" name="FarsiGrade1" ng-change="FarsiGradeCheck()" ng-init="user.FarsiGrade = '---'" ng-model="user.FarsiGrade1" ng-style="FarsiGradeStyle" ng-disabled="isDisabled"> <%
				...
				<td colspan="1" >
					<select class="fix" style="background: white" name="Restriction1" ng-init="user.Restriction = 'No'" ng-disabled="isDisabled" ng-model="user.Restriction1" >
			...
			<tr>
				<td colspan="1">AddressDDD</td>
				<td colspan="3"><input class="fix" type="text" name="Address1" ng-model="user.Address1" required="required" ng-disabled="isDisabled" placeholder=" *" /></td>
			</tr>
			<tr>
				<td colspan="1">
					City
				...
				<td colspan="3">
					<select class="fix" style="background: white" name="City1" ng-model="user.City1" ng-init="user.City = 'No'" ng-change="cityCheck()" ng-disabled="isDisabled" ng-style="CityStyle"  >
						<option value="No">-----------</option>
			...
			<tr>
				...
				<td colspan="3"><input class="fix" type="text" name="PostalCode1" maxlength="6" ng-model="user.PostalCode1" ng-change="postalcodeCheck()" onchange="this.value=removeSpaces(this.value);" required="required" ng-disabled="isDisabled" placeholder=" *" /></td>
			</tr>
			<tr>
				<td colspan="1">Password</td>
				<td colspan="3"><input class="fix" type="password" name="Password1" maxlength="10" ng-model="user.Password1" ng-change="passCheck()" required="required" ng-disabled="isDisabled" placeholder=" *" /><div ng-messages="registrationForm.password.$error" ng-messages-include="Messages.html"></div></td>
			</tr>
			<tr>
				<td colspan="1">Retype Password</td>
				<td colspan="3"><input class="fix" type="password" name="RePass1" maxlength="10" ng-model="user.RePass1" ng-change="passCheck()" compare-to="user.Password" ng-disabled="isDisabled" required="required" placeholder=" *" /><div ng-messages="registrationForm.RePass.$error" ng-messages-include="Messages.html"></div></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="3"><textarea class="text_area" name="Details1" ng-disabled="isDisabled" ng-model="user.Details1"></textarea></td>
			</tr>
			<tr>
				<td colspan="4"><label><input type="checkbox" name="term1" ng-model="user.Term1" ng-change="TermCheck()" ng-disabled="isDisabled" style="text-shadow: 3px 3px 8px #252525; outline: 1px solid #1e5180"> &nbsp; To review terms and conditions <a target="_blank" href="Terms_Conditions.html"> click here!</a></label></td>
			</tr>
			<tr>
				<td class="curve-bottom" colspan="4">
					...
					<button type="button" class="button" onclick="profileForm(this)">Edit</button>
			...
			<tr>
				...
				<td>
					<div>
       					<directive-name name="test" parameter="{{obj}}"></directive-name>
    				</div>
				</td>
			</tr>
		</table>
		...
		<div id="swap2">
		  <table class="curve tbl_reg">
			<tr>
				<td colspan="1">First Name</td>
				<td colspan="3"><input class="fix" type="text" id="Name" name="Name" ng-model="user.Name2" value="" required="required" placeholder=" *" ng-disabled="isDisabled"/></td>
		<!-- 	<td colspan="3"><input class="fix" type="text" id="Name" name="Name" ng-model="user.Name" value= //session.getAttribute("username").toString() required="required" placeholder=" *" ng-disabled="isDisabled"/></td> -->
			</tr>
			<tr>
				<td colspan="1">Last Name</td>
			...
			<tr>
				<td colspan="4"><label><input type="checkbox" name="term" ng-model="user.Term" ng-change="TermCheck()" ng-disabled="isDisabled" style="text-shadow: 3px 3px 8px #252525; outline: 1px solid #1e5180"> &nbsp; To review terms and conditions <a target="_blank" href="Terms_Conditions.html"> click here!</a></label></td>
			</tr>
			<tr>
				<td class="curve-bottom" colspan="4">
					<input type="submit"  class="button"  value="Submit" ng-disabled="isSubDisabled" ng-click="SubmitDisable()" />
