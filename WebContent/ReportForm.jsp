    ...
    <body >
        ...
        <div id="ViewBody">
            <table class="curve header_tbl" >
                   	<tr>
                        <th class="curve-top" colspan="5"  id="repoTitle" >کارنامه دانش آموز</th><th colspan="2"><img id="Ghadir_Logo_small" alt="GhadirLogo" src="img/Ghadir LOGO.jpg"></th>
                    </tr>
	               	<tr>
                        <td colspan="3">کد دانش آموز</td>
                        <td></td>
	               		<td></td>
                        <td><input id="fix" type="text" name="userid" value="${userid}" readonly/></td>
                        <td colspan="2" >سال تحصیلی</td>
                        <td style="text-align:right;"><input type="text" class="fix2" id=fordate value="${ForDate}" readonly/></td>
                        <td></td>
                    </tr>
                    <tr>
                        ...
                        <td></td>
 						<td></td>
 						<td><input id="fix" type="text" name="name" value="${stdNameFamily}" readonly/></td>
                        <td>کلاس</td>
                        <td style="text-align:left;"><input type="text" class="fix2" id=forclass value="${ForClass}" readonly/></td>
                        <td></td>
                    </tr>
             ...
             <table class="curve body_tbl">
                    ...
                    <tr>
 						<td>
							<table class="body_tbl2">
								<tr>
									<th rowspan="3" class="vertical" style="width:5%; padding:0%;">فارسی</th><td class="lr Center">املاء</td><td class="Center" style="width:20%; padding:3%;">${Dictation}</td>
								</tr>
								<tr>
									<td class="lr ub Center">انشاء و دستور</td><td class="ub Center" >${Grammar}</td>
								</tr>
								<tr>
									<td class="lr Center">روخوانی</td><td class="Center" style="width:20%; padding:3%;">${Reading}</td>
								</tr>
							</table>
 						</td>
                    ...
                    <tr>
                        <th style="border-top:1px solid #5500aa; padding:3%;">انضباط کل</th>
        ...
        <div id="ViewBody">
            <table class="curve header_tbl" >
	               	...
	               	<tr>
                        ...
                        <td></td>
	               		<td></td>
                        <td><input id="fix" type="text" name="userid2" value="${userid2}" readonly/></td>
                        <td colspan="2" >سال تحصیلی</td>
                        <td style="text-align:right;"><input type="text" class="fix2" id=fordate value="${ForDate}" readonly/></td>
                        <td></td>
                    </tr>
                    <tr>
                        ...
                        <td></td>
 						<td></td>
 						<td><input id="fix" type="text" name="name" value="${stdNameFamily2}" readonly/></td>
                        <td>کلاس</td>
                        <td style="text-align:left;"><input type="text" class="fix2" id=forclass2 value="${ForClass2}" readonly/></td>
                        <td></td>
                    </tr>
             ...
             <table class="curve body_tbl">
                    ...
                    <tr>
 						<td>
							<table class="body_tbl2">
								<tr>
									<th rowspan="3" class="vertical" style="width:5%; padding:0%;">فارسی</th><td class="lr">املاء</td><td class="Center" style="width:20%; padding:3%;">${Dictation2}</td>
								</tr>
								<tr>
									<td class="lr ub">انشاء و دستور</td><td class="ub Center" style="width:20%; padding:3%;">${Grammar2}</td>
								</tr>
								<tr>
									<td class="lr">روخوانی</td><td class="Center" style="width:20%; padding:3%;">${Reading2}</td>
								</tr>
							</table>
 						</td>
